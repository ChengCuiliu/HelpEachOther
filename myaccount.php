...
<body>
  <div class="container">
    <h2>我的用户名：<?php echo $Name; ?></h2>
    <h3>我的河大学号：<?php echo $hid; ?></h3>
    <h3>我的邮箱：<?php echo $email; ?></h3>
    <h3>我的手机号码：<?php echo $phone; ?></h3>

    <br>
    <h3><a href="myItem.php">我发布的物品</a></h3>
    <h3><a href="myPost.php">我发布的帖子</a></h3>
    <h3><a href="myOrder.php">我的订单</a></h3>
